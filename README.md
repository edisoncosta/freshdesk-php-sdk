...
[![Packagist](https://img.shields.io/badge/Packagist-freshdesk--php--sdk-blue)](https://packagist.org/packages/keepcloud/freshdesk-php-sdk)

This is a PHP 5.6+ SDK for the [Freshdesk](https://www.freshdesk.com) API v2.
...
- Laravel/Lumen - [Freshdesk Larvel Service Provider](https://github.com/keepcloud/freshdesk-laravel) .

## Installation

To integrate this library into your application, use [Composer](https://getcomposer.org).

Add `keepcloud/freshdesk-php-sdk` to your **composer.json** file:

```json
{
    "require": {
        "keepcloud/freshdesk-php-sdk": "dev-master"
    }
}
```
